...
class MilestoneRepositoryTest {
    ...
    void countByIsClosed() {
        milestoneRepository.save(new Milestone(null, "1", null, null, false));
        milestoneRepository.save(new Milestone(null, "2", null, null, false));
        milestoneRepository.save(new Milestone(null, "3", null, null, true));
    ...
    @Test
    void closeById() {
        Milestone saved = milestoneRepository.save(new Milestone(null, "1", null, null, false));
